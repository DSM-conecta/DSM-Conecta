...
exports.EXPANSION_MAX_DEPTH = exports.EXPANSION_MAX_LENGTH = exports.EXPANSION_MAX = void 0;
...
function expand(str, options = {}) {
    ...
    const { max = exports.EXPANSION_MAX, maxLength = exports.EXPANSION_MAX_LENGTH, maxDepth = exports.EXPANSION_MAX_DEPTH, } = options;
    ...
    return expand_(escapeBraces(str), max, maxLength, maxDepth, 0, true).map(unescapeBraces);
}
...
function expand_(str, max, maxLength, maxDepth, depth, isTop) {
    ...
    for (;;) {
        ...
        if (isSequence) {
            ...
            if (n.length === 1 && n[0] !== undefined) {
                // x{{a,b}}y ==> x{a}y x{b}y
                n = expand_(n[0], max, maxLength, maxDepth, depth + 1, false).map(embrace);
            ...
            outer: for (let j = 0; j < n.length; j++) {
                const expanded = expand_(n[j], max, maxLength, maxDepth, depth + 1, false);
